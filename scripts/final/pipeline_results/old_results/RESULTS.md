...
**Plagdet — FINAL (308-doc full corpus, official score):**
...
| Obfuscation | plagdet | Precision | Recall |
|-------------|---------|-----------|--------|
...
- Retrieval recall@20: 0.753 (80) → 0.640 (212) → 0.607 (308) — later docs are harder for retrieval
